...
class Analysis extends Component {
     ...
     <p className="text-justify serviceDescription">Hi! I'm Ali Sinjary. I'm a web developer with a serious love for teaching I am a founder of eLe easy Learning and a passionate Web Developer, Programmer & Instructor.<br></br><br></br>
